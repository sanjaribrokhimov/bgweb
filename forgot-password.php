        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('forgotPasswordForm').addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    const response = await fetch('http://173.212.234.202/api/auth/forgot-password', {
                        method: 'POST',
                        headers: {
                    ...
                    if (response.status === 200) {
                        ...
                        const userResponse = await fetch(`http://173.212.234.202/api/auth/user?email=${encodeURIComponent(email)}`);
                        if (userResponse.ok) {
