class BloggerLoader {
    ...
    async loadBloggers() {
        ...
        try {
            ...
            const url = `http://bgweb.nurali.uz/api/ads/category/blogger?page=${this.page}&limit=${this.limit}`;
    ...
    async showDetails(id) {
        try {
            ...
            const response = await fetch(`http://bgweb.nurali.uz/api/ads/details/blogger/${id}`);
