class BloggerLoader {
    ...
    async loadBloggers() {
        ...
        try {
            ...
            const url = `https://173.212.234.202/api/ads/category/blogger?page=${this.page}&limit=${this.limit}`;
    ...
    async showDetails(id) {
        try {
            ...
            const response = await fetch(`https://173.212.234.202/api/ads/details/blogger/${id}`);
            if (!response.ok) {
