class CompanyLoader {
    ...
    async loadCompanies() {
        ...
        try {
            ...
            const url = `http://bgweb.nurali.uz/api/ads/category/company?page=${this.page}&limit=${this.limit}`;
    ...
    async showDetails(id) {
        try {
            ...
            const response = await fetch(`http://bgweb.nurali.uz/api/ads/details/company/${id}`);
