class CompanyLoader {
    ...
    async loadCompanies() {
        ...
        try {
            ...
            let url = `https://173.212.234.202/api/ads/category/company?page=${this.page}&limit=${this.limit}`;
    ...
    async showDetails(id) {
        try {
            ...
            const response = await fetch(`https://173.212.234.202/api/ads/details/company/${id}`);
