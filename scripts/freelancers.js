class FreelancerLoader {
    ...
    async loadFreelancers() {
        ...
        try {
            ...
            const url = `http://bgweb.nurali.uz/api/ads/category/freelancer?page=${this.page}&limit=${this.limit}`;
    ...
    async showDetails(id) {
        try {
            ...
            const response = await fetch(`http://bgweb.nurali.uz/api/ads/details/freelancer/${id}`);
