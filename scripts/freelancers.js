class FreelancerLoader {
    ...
    async loadFreelancers() {
        ...
        try {
            ...
            const url = `http://144.126.128.67:8888/api/ads/category/freelancer?page=${this.page}&limit=${this.limit}`;
    ...
    async showDetails(id) {
        try {
            ...
            const response = await fetch(`http://144.126.128.67:8888/api/ads/details/freelancer/${id}`);
